<?php
require_once('imagelib/confidentcaptcha/ConfidentCaptchaCredentials.php');
require_once('imagelib/confidentcaptcha/ConfidentCaptchaProperties.php');
require_once('imagelib/confidentcaptcha/ConfidentCaptchaResponses.php');
require_once('imagelib/confidentcaptcha/ConfidentCaptchaSession.php');
...
class ConfidentCaptchaClient
{
     ...
     */
    private $libraryVersion = "20130514_PHP_2.5";
    ...
    public function checkClientSetup()
    {
        ...
        $localClientCheckpointsHolder[] = array("library_version", $localLibraryVersion, 'example: 20130514_PHP_2.5', $libraryVersionSupported);
        ...
        $currentKnownProperties = array(
            ...
            'height'=> '(default: 3)',
            'width'=> '(default: 3)',
            'captcha_length'=> '(default: 3)',
            'captcha_color'=> '(default: Pearl)',
