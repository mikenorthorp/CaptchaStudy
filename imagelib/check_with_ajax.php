...
$checkInstructions = "Your configuration is supported by the
        Confident CAPTCHA PHP sample code. Use this <tt>settings-for-ajax.xml</tt> file in
        your own project.";
...
if (!$configGood) {
    ...
    $checkInstructions = "<b>Your configuration is <i>not</i> supported
        ...
        errors in <tt>settings-for-ajax.xml</tt> before trying the samples and integrating into your own
        project.";
}
...
<body>
 ...
 <p>
   ...
   Confident CAPTCHA.  Local configuration is set in <tt>settings-for-ajax.xml</tt>, and
