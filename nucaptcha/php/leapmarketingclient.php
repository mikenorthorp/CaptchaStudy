...
define("LEAP_LIBRARY_VERSION", 'Dev: $Change: 16622 $');
...
{
	define('LM_FALLBACK_TOKEN_SERVER', 'http://token.nucaptcha.com/' );
}
if(!defined('LM_FALLBACK_VALIDATE_SERVER'))
{
	define('LM_FALLBACK_VALIDATE_SERVER', 'http://validate.nucaptcha.com/' );
}
