...
abstract class lmcTransactionInterface
{
	...
	public function GetPersistentData()
	{
        ...
        if ($resourceServer != null)
            $chunk->AddChunk("RSERV", $resourceServer);
        $securityServer = $this->getSecurityServer();
        if ($securityServer != null)
            $chunk->AddChunk("SSERV", $securityServer);
    ...
    /**
	 * Gets the URL to the resource server.
	 *
	 * NOTE: not for public consumption. This is used for testing.
	 *
	 * @return string
    ...
    /**
	 * Gets the URL to the security server.
	 *
	 * NOTE: not for public consumption. This is used for testing.
	 *
	 * @return string
